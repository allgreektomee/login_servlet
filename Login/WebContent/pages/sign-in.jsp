...
<head>
  ...
  <!-- CSS Files -->
  <link id="pagestyle" href="${pageContext.request.contextPath}/assets/css/material-dashboard.css?v=3.0.0" rel="stylesheet" />
</head>
...
<body class="bg-gray-200">
              ...
              <div class="card-body">
                ...
                <form role="form" method="post" action="/Login/LoginController?action=main"  class="text-start">
                  ...
                  <p class="mt-4 text-sm text-center">
                    ...
                    <a href="/Login/pages/sign-up.jsp" class="text-primary text-gradient font-weight-bold">Sign up</a>
                  </p>
                </form>
  ...
  <script src="${pageContext.request.contextPath}/assets/js/material-dashboard.min.js?v=3.0.0"></script>
</body>
